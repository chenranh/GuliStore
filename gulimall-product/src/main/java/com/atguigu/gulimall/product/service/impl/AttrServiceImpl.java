...
//        attrEntity.setAttrName(attr.getAttrName());
    ...
    /**
     * 根据分组id查找关联的所有基本属性
     * 在attr_group_relation里找到attrId，再去attr表查询信息
     *
     * @param attrgroupId
     * @return
     */
     ...
     */
    @Override
    public List<AttrEntity> getAtrrListByIds(List<Long> attrIdList) {
        List<AttrEntity> attrEntities = (List<AttrEntity>) this.listByIds(attrIdList);
        return attrEntities;
    }
